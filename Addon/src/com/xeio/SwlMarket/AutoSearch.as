...
class com.xeio.SwlMarket.AutoSearch
{
    ...
    static var m_searches : Array = [
        ...
        //misc
        [109918787, 226155763, "", 6], //Gadget
        [109918787, 180871029, "", -1], //Consumable
        [109918787, 180871029, "Key ", -1],
        [109918787, 180871029, "agar", -1],
        [109918787, 180871029, "infer", -1],
        [109918787, 180871029, "haunt", -1],
        [109918787, 180871029, "wint", -1],
        [109918787, 180871029, "futu", -1],
        [109918787, 180871029, "tribal", -1],
        [109918787, 180871029, "oni ", -1],
        [109918787, 197642084, "", -1], //Essence
        ...
        [111398483, 57339111, "tribal", -1],
        [111398483, 57339111, "oni ", -1],
        ...
        [208570357, 94364868, "nem", -1],
        [208570357, 84122562, "", -1], //Imbuer
        ...
        //Agents
        [4709460, 253188674, "", -1], //Dossiers
        [4709460, 130331812, "", 4], //Equipment
        [4709460, 130331812, "", 5]
    ];
